...
<body>
   <img src="<c:url value="resources/pics/flipkart-shoes.jpg"/>" width="1400" height="200"/>
<%--<img src="<c:url value="resources/pics/womens-shoes.jpg"/>" width="1450" height="200"/> --%>
<marquee bgcolor="yellow">Welcome to FootBazzar..Happy shopping folks...</marquee>
 ...
 <nav class="navbar navbar-inverse">
		...
		<marquee bgcolor="skyblue" direction="right"><legend>Always you can grab your shoes from us...</legend></marquee>
	...
	<div id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item active">
				<img src="<c:url value="resources/pics/caro1.jpg"/>" alt="bt1" width="500" height="500"/> 
			...
			<div class="item">
				<img src="<c:url value="resources/pics/caro2.jpg"/>" alt="bt2" width="500" height="500"/> 
				<div class="carousel-caption">
					<h3>Formal Shoes</h3>
			...
			<div class="item">
				<img src="<c:url value="resources/pics/caro3.jpg"/>" alt="bt3" width="500" height="500"/> 
				<div class="carousel-caption">
					<h3>Sports Shoes</h3>
	...
	<div class="jumbotron">
		<div class="container text-center">
			<h1>Online Shoes Store</h1>
			<p>Make us to carry you through...</p>
		</div>
	</div>
